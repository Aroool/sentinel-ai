      ...
      <div className="relative max-w-7xl mx-auto px-6 py-10">
        ...
        >
          <div className="mb-4 flex items-center gap-3">
            <motion.div
              animate={{ boxShadow: ["0 0 0px #3b82f6", "0 0 18px #3b82f6", "0 0 0px #3b82f6"] }}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <textarea
              ...
              defaultValue="Push this code to main"
            />
          ...
          >
            ...
            <div className="flex gap-3">
              <motion.button
                ...
                className="flex-1 rounded-2xl bg-emerald-600 px-4 py-3 font-medium hover:bg-emerald-700 transition shadow-lg shadow-emerald-600/20"
              >
                Approve
              </motion.button>
